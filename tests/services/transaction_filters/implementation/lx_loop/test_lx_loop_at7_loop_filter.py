...
from app.services.transaction_filters.implementation.lx_loop.lx_loop_at7_loop_filter import LxLoopAt7LoopTransactionFilter
...
def test_lx_loop_at7_loop_filter(
    ...
    assert "X6" == (
        ...
        ["LX_loop"][0]
        ["AT7_loop"][0]
        ["shipmentStatusDetails"][0]
        ["shipmentStatusIndicatorCode"]
    )
