...
@pytest.fixture
def s5_loop_n1_loop_filter() -> S5LoopN1LoopTransactionFilterJson:
    return S5LoopN1LoopTransactionFilterJson()


def test_s5_loop_n1_loop_filter(
    transactions_response: dict[str, Any],
    s5_loop_n1_loop_filter: S5LoopN1LoopTransactionFilterJson,
) -> None:
