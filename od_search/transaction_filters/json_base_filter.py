...
class JsonBaseTransactionFilter(BaseTransactionFilter, metaclass=abc.ABCMeta):
    def __init__(self, filter_name: JsonTransactionFilterNameFormat, jpath_query: str):
        if not filter_name:
